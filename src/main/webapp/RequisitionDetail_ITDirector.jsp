...
<%
    ...
    NavigationUtil.BackLink backLink = NavigationUtil.approvalDetailBack(
        request.getContextPath(), fromPage, "/itDirectorApprove", "กลับหน้า IT Director Approval"
    );
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .section-box { border: 2px solid var(--slf-color-accent); border-radius: var(--slf-radius-md); padding: 20px; margin-bottom: 25px; background: var(--slf-color-surface); }
...
<div class="form-container">
    ...
    <% } else { %>
        <form action="SubmitApprovalServlet" method="post">
            ...
            <!-- IT Director comment box (preserved from original) -->

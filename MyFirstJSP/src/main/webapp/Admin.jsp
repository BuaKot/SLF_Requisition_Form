    ...
    <%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <body>
            <div id="mySidebar" class="sidebar">
                <a href="javascript:void(0)" style="font-size:2.5rem; padding: 0 20px;"
                    onclick="toggleNav()">&times;</a>
            ...
            <div class='sticky-bar'>
                <i class="fa fa-bars" onclick="toggleNav()"
                    style="font-size:1.8rem; cursor:pointer; color:#333; padding: 10px;"></i>

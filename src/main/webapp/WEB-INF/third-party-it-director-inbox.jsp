...
<style>.inbox{max-width:1180px;margin:0 auto;padding:28px 28px 48px}.group{margin-top:28px}.group h2{color:#003366}.list{display:grid;gap:14px}.item{display:block;padding:20px;background:#fff;border:2px solid #d9e6f2;border-radius:12px;box-shadow:0 8px 22px rgba(0,51,102,.06);text-decoration:none;transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease}.item:hover,.item:focus-visible{transform:translateY(-2px);border-color:#3272bb;box-shadow:0 12px 26px rgba(0,51,102,.14);outline:none}.item h3{margin:0 0 8px;color:#003366}.meta{display:flex;flex-wrap:wrap;gap:8px 20px;color:#526b80}.empty{padding:24px;text-align:center;background:#fff;border:1px dashed #bfd0df;border-radius:10px;color:#526b80}@media(max-width:720px){.inbox{padding:20px 14px}}</style></head><body>

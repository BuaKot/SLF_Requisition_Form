...
<head>
    ...
    <style>
        .operator-review{max-width:1180px;margin:0 auto;padding:28px 28px 48px}.review-panel{background:#fff;border:1px solid #d9e6f2;border-radius:10px;padding:22px;margin-bottom:18px;box-shadow:0 8px 22px rgba(0,51,102,.06)}
        .review-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:15px 20px}.review-field{border-bottom:1px solid #e5eef6;padding-bottom:10px}.review-field.full{grid-column:1/-1}
        .review-label{color:#64748b;font-size:13px;font-weight:800;margin-bottom:5px}.review-value{color:#102a43;line-height:1.55;white-space:pre-wrap;overflow-wrap:anywhere}.access-item{border:1px solid #d9e6f2;border-radius:8px;padding:16px;margin-top:14px}
        .comment-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.comment-card{padding:16px;border-radius:8px;background:#f6f9fc;border:1px solid #d9e6f2}
        .operation-box textarea{width:100%;min-height:150px;border:1px solid #bfd0df;border-radius:7px;padding:12px;font:inherit;resize:vertical}.submit-row{display:flex;justify-content:flex-end;margin-top:18px}
        @media(max-width:800px){.operator-review{padding:18px 14px 36px}.review-grid,.comment-grid{grid-template-columns:1fr}.review-field.full{grid-column:auto}.submit-row button{width:100%}}
    </style>
</head>
<body>

...
<style>
body{margin:0;background:#f4f8fc;font-family:Tahoma,Arial,sans-serif;color:#102a43}.accept-page{max-width:1000px;margin:0 auto;padding:28px 18px 48px}.accept-head,.panel{background:#fff;border:1px solid #d9e6f2;border-radius:10px;padding:22px;margin-bottom:18px;box-shadow:0 8px 22px rgba(0,51,102,.06)}
.accept-head{background:#073a73;color:#fff}.accept-head h1{margin:0 0 8px}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:15px 20px}.field{border-bottom:1px solid #e5eef6;padding-bottom:10px}.full{grid-column:1/-1}.label{color:#64748b;font-size:13px;font-weight:bold;margin-bottom:5px}.value{line-height:1.55;white-space:pre-wrap;overflow-wrap:anywhere}.access{border:1px solid #d9e6f2;border-radius:8px;padding:14px;margin-top:12px}textarea,select{width:100%;box-sizing:border-box;border:1px solid #bfd0df;border-radius:7px;padding:11px;font:inherit}textarea{min-height:130px;resize:vertical}.actions{text-align:right;margin-top:18px}@media(max-width:700px){.grid{grid-template-columns:1fr}.full{grid-column:auto}}

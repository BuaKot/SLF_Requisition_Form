    ...
    <main class="third-party-request-page">
        <section class="third-party-page-head third-party-toolbar-head">
            ...
            <div class="page-head-actions">
                <a class="btn btn-secondary action-pill" href="${pageContext.request.contextPath}/newForm">
                ...
                <form method="post" action="${pageContext.request.contextPath}/thirdParty/request/new">
                    ...
                    <button class="btn btn-primary action-pill primary-action" type="submit">
        ...
        <% } else if ("cancelled".equals(status)) { %>
            <div class="form-alert neutral">ยกเลิกฟอร์มและปิดลิงก์เรียบร้อยแล้ว</div>
        ...
        <section class="third-party-panel">
            <div class="third-party-list-head">
                <div>
                    ...
                    <p class="muted-text">แสดงสถานะล่าสุดของแต่ละรายการโดยไม่แสดง URL ยาว ๆ เพื่อให้ดูง่ายและไม่รกตา</p>
                </div>
...
function confirmCancelThirdPartyLink() {
    return window.confirm("ยืนยันยกเลิกฟอร์มนี้หรือไม่? ลิงก์จะถูกปิดและผู้ให้บริการภายนอกจะไม่สามารถกรอกผ่านลิงก์นี้ได้");
}
function toggleNav() {

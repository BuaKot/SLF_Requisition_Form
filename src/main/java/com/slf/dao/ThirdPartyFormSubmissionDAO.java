...
public class ThirdPartyFormSubmissionDAO {
    ...
    public void submitOnce(ThirdPartyFormSubmission submission) throws SQLException {
        ...
        String updateRequestSql =
            "UPDATE THIRD_PARTY_REQUEST r SET STATUS = 'SUBMITTED', " +
            "EXTERNAL_COMPANY_NAME = ?, EXTERNAL_CONTACT_NAME = ?, EXTERNAL_EMAIL = ?, EXTERNAL_PHONE = ?, " +
            "PURPOSE = ?, TARGET_SYSTEM = ?, ACCESS_START_DATE = ?, ACCESS_END_DATE = ?, " +
            "SUBMITTED_AT = SYSTIMESTAMP, UPDATED_AT = SYSTIMESTAMP " +
